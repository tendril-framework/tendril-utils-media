...
``tendril-utils-media`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-utils-media
...
`github releases <https://github.com/tendril-framework/tendril-utils-media/releases>`_.
...
``tendril-utils-media``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-utils-media.git
    $ cd tendril-utils-media
    $ pip install -e .
